...
title: Installation
description: Install Argent with npx @swmansion/argent init. The wizard installs the package, registers the MCP server in your editor and copies the agent skills into your workspace.
